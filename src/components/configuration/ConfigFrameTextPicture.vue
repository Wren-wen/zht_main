<template>
    <div class="ConfigFrame">
        <div v-drag:frameTextPicture.root="frameBackup" class="content">
            <TransitionGroup name="drag-list">
                <div class="tool" v-for="(tool_, idx) in frameBackup" :key="tool_.id">
                    <div @click="tool_.flod = !tool_.flod" class="flodbar">
                        <div @click.stop v-drag:frameTextPicture.target="tool_" class="iconfont icon-tuozhuai"></div>
                        <div class="title">
                            <span>选项卡</span>{{ tool_.raw.zh }}
                        </div>
