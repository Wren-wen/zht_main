    ...
    <div class="ArticleContent">
        <div class="editbox scrollBar">
            ...
            <div class="bar flexStart">
                ...
                <config-image v-if="article_edit?.hasOwnProperty('cover')"
                    v-model:cover="article_edit.cover"></config-image>
            </div>
            <div class="bar flexStart">
                <div class="tit marginTop">
                    标签:
            ...
            <div class="bar flexStart">
                ...
                <config-frame v-if="article_edit?.hasOwnProperty('frame')" v-model:frame="article_edit.frame"></config-frame>
            </div>
        </div>
        <div class="showbox">
            <config-show>
                <article-news :article="article_edit"></article-news>
            </config-show>
        </div>
    </div>
</template>
...
<script setup>
import { ref, toRaw, onMounted, onUnmounted, inject, toRef, watch } from 'vue'
